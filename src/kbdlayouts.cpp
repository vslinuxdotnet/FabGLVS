...
const KeyboardLayout PortugueseLayout {
  ...
  // single byte scancodes
  {
    { 0x0E, VK_BACKSLASH },// \|
    { 0x4E, VK_QUOTE },
    { 0x55, VK_GREATER }, // « » to fix GUILLEMET char, const VirtualKey VK_GUILLEMET_RIGHT  = (VirtualKey) 0xBB;  //(136+0x2E);
    { 0x5D, VK_TILDE },//~^


    { 0x54,  VK_PLUS },//+ * VK_GRAVEACCENT
    { 0x5B,  VK_ACUTEACCENT},//' `
  ...
  //  in_key, { CTRL, LALT, RALT, SHIFT }, out_key
  {
    ...
    { VK_3,           { 0, 0, 0, 1 }, VK_HASH },           // SHIFT "3" = "#"
    { VK_3,           { 0, 0, 1, 0 }, VK_POUND },          // ALT "3" = "£"

    { VK_4,           { 0, 0, 0, 1 }, VK_DOLLAR },         // SHIFT "4" = "$"
    { VK_4,           { 0, 0, 1, 0 }, VK_SECTION },        // ALT 4" = "§"
    ...
    { VK_PLUS,        { 0, 0, 0, 1 }, VK_ASTERISK },      // SHIFT "'" = "*"
    { VK_PLUS,        { 0, 0, 1, 0 }, VK_DIAERESIS },  // ALT "'" = ".."

    { VK_CEDILLA_c,   { 0, 0, 0, 1 }, VK_CEDILLA_C },     // SHIFT "ç" = "Ç" // should be upper case

    { VK_ACUTEACCENT, { 0, 0, 0, 1 }, VK_GRAVEACCENT},     // SHIFT   "´" = "`" // should be diaeresis for vocals
